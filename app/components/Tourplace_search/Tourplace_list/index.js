...
class Tourplace_list extends React.Component {
    ...
    _getData = async () =>{
        ...
        fetch('http://192.168.219.101:3000/tour/title/'+ this.state.keyword+"/"+this.state.page)
